            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: hello@shopmax.com<br />
                      Support: support@shopmax.com<br />
                      Press: press@shopmax.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-orange-500 hover:text-white transition-colors">
